...
export const flagshipCaseStudies: FlagshipCaseStudy[] = [
  ...
  },
  {
    ...
    status: "prototype",
    priority: 4,
    oneLiner: "Developer-tooling prototype exploring git hooks, AI-assisted review agents, CI simulation, CLI workflows, and security hardening.",
    problem: "Developers often receive feedback too late in the workflow. CI may catch issues after context has moved on, while AI review in a chat window is disconnected from commits, hooks, code context, and team workflow.",
    solution: "Designed a phased platform around git hooks, CLI commands, backend analysis endpoints, AI-assisted review, agent roles, and a simulator/gateway shape, with security hardening for payload limits, input validation, rate limiting, headers, and auditability.",
    impact: [
    ...
    techStack: ["Node.js", "TypeScript", "Git Hooks", "CLI", "AI Review", "Security"],
    role: [
      "Developer-tooling system designer",
      "CLI and git-hook workflow builder",
  ...
  },
  {
    ...
    status: "prototype",
    priority: 5,
    oneLiner: "Local-first AI operations assistant prototype for small-business admin workflows, turning emails, quote requests, documents, voice notes, and follow-ups into structured tasks with operator approval.",
    problem: "Small operators lose time in admin work: quotes, invoices, Gmail follow-ups, job notes, payments, and paperwork. Existing tools can be expensive, cloud-first, keyboard-centric, and disconnected from field work.",
    solution: "Designed the offline direction around an operator-owned business OS where AI can draft, classify, and organize work while the operator approves before anything leaves the system.",
    impact: [
      "Defined a local-first product direction for small-business admin automation.",
      "Modeled messy business inputs as auditable, structured workflows.",
      "Kept privacy, local ownership, and human approval central to the design.",
    ],
    technicalHighlights: [
      "Email triage pipeline with Gmail/IMAP input, AI classification, pending approvals, and send/archive planning",
      "Human-in-the-loop rule for outbound email, quote, post, payment, and destructive actions",
      "Local-first storage direction with SQLite first and PostgreSQL/self-hosted path later",
      "AI fallback strategy across Ollama, OpenRouter, and Gemini",
      "Construction workflow modeling for leads, quotes, invoices, payments, job files, ABN/GST validation, and pipeline visibility",
      "Voice command interface direction with screen context and confirmation cards",
      "RAG and document-intelligence direction using Google Drive sync and semantic search",
    ],
    techStack: ["Python", "FastAPI", "Flutter", "SQLite", "Gmail", "Ollama", "Gemini", "RAG"],
    role: [
