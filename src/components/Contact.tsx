          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {Object.entries(socialLinks).map(([key, url]) => (
              ...
              >
                ...
                {key === 'github' && (
                  <svg className="h-8 w-8 text-stone-200 group-hover:text-stone-950" fill="currentColor" viewBox="0 0 24 24">
                ...
                {key === 'email' && (
                  <svg className="h-8 w-8 text-stone-200 group-hover:text-stone-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                )}
                <span className="mt-3 text-sm font-black capitalize">{key}</span>
              </motion.a>
            ))}
          </div>
