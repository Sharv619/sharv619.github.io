          ...
          <div className="flex justify-center space-x-8 mb-8">
            {Object.entries(socialLinks).map(([key, url]) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-4 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors duration-300 group"
              >
                ...
                {key === 'email' && (
                  <svg className="w-8 h-8 text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
