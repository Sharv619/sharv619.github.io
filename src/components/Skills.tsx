  ...
  return (
    <section id="skills" className="flex items-center bg-[#f7f4ed] py-20 dark:bg-[#101010]">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-[0.58fr_1.42fr] lg:px-8">
        ...
        <div className="grid max-h-[68svh] grid-cols-1 gap-4 overflow-y-auto pr-1 md:grid-cols-2 xl:grid-cols-3">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-lg border border-stone-300 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-[#171715]"
            >
              <h3 className="mb-4 text-xl font-black text-stone-950 dark:text-white">
                {category.title}
              </h3>
